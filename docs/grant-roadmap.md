...
- Letztes Update: `CLI-005` abgeschlossen (Polling-Loop inkl. Intervall/Jitter und ack-flow-konformer Poll-Zyklen) in `apps/ble_spike/lib/transport/relay_link.dart`, `apps/ble_spike/test/relay_link_test.dart` und `docs/roadmap-client-remote-transport-v1.md`.
- Naechster auszufuehrender Block nach Regel "Naechster Task": `CLI-*` aus `docs/roadmap-client-remote-transport-v1.md`.
- Naechster konkreter Task: `CLI-006` (erster offener Punkt in `docs/roadmap-client-remote-transport-v1.md`).
...
- [ ] CLI-006.. : siehe `docs/roadmap-client-remote-transport-v1.md`
